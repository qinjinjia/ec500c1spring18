...
For the code reviewed, [**TwitterSumarization.py**](https://github.com/abbottn3/EC500/blob/master/TwitterSummarization.py), **the code is Synchronous** as the code returns data for requests immediately. We need to wait until all images are downloaded to continue next step.
